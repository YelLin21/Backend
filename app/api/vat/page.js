            ...
            <table >
                <tbody >
                    <tr>
                        ...
                        <td><input type="number" name="price" style={{ color: "blue" }}
                            {...register("price", { valueAsNumber: true })} /></td>
                    </tr>
                    <tr>
                        <td><label>VAT Rate:</label></td>
                        <td><input type="number" name="rate" value={rate} style={{ color: "blue" }} readOnly
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="vat" style={{ color: "blue" }} value={vat} /></td>
                    </tr>
                </tbody>
            </table>
        </form>
